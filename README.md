...
* External Display issues: 
   * IMPORTANT! I HEARD (Haven't confirm by myself) that for now in Catalina there is no displaylink support. Do not update to Catalina if you need to use displaylink. More info from [DisplayLink's Support on Catalina](https://support.displaylink.com/knowledgebase/articles/1916602-macos-catalina-10-15-beta).
