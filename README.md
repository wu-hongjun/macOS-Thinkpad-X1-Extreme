...
* [20181030] Uploaded [BOOT4.0-LEGACY](https://github.com/Errrneist/Hackintosh-Thinkpad-X1-Extreme/tree/master/10.14.0/4.0-SLEKexts) which installed most KEXT into S/L/E. See ["./KernalExtentions/"](https://github.com/Errrneist/Hackintosh-Thinkpad-X1-Extreme/tree/master/KernalExtentions).
...
* [20181028] Clover have UEFI64Driver(OPTIONAL) support FileVault2. Still, make sure you get everything else working first.
